...
export const media = pgTable(
  'media',
  {
    ...
    sizes_blur_url: varchar('sizes_blur_url'),
    sizes_blur_width: numeric('sizes_blur_width', { mode: 'number' }),
    sizes_blur_height: numeric('sizes_blur_height', { mode: 'number' }),
    sizes_blur_mimeType: varchar('sizes_blur_mime_type'),
    sizes_blur_filesize: numeric('sizes_blur_filesize', { mode: 'number' }),
    sizes_blur_filename: varchar('sizes_blur_filename'),
  ...
  (columns) => [
    ...
    index('media_sizes_blur_sizes_blur_filename_idx').on(columns.sizes_blur_filename),
